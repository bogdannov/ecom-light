...
class Category extends Model
{
    ...
    /**
     * Relations with filter and optionalGroups
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo with BelongsToMany
     */
    public function filterWithOptionGroups()
    {
        return $this->filter()->with('optionGroups');
    }

    /**
     *
     * Relations with filter and OptionalGroupsAndOptions
     *
     */
    public function filterWithOptionGroupsAndOptions()
    {
        return $this->filter()->with('optionGroupsWithOptions');
    }
