...
class CategoryDashboardController extends Controller
{
    ...
    public function index(Ecommerce $ecommerce)
    {
        ...
        $content =  view('ecommerce::categories.categories', compact('menu_control', 'categories'));
    ...
    public function create(Ecommerce $ecommerce)
    {
        ...
        $content = view('ecommerce::categories.create', compact('category', 'categories', 'menu_control', 'filters', 'options'));
    ...
    public function edit($id, Ecommerce $ecommerce)
    {
        ...
        $content = view('ecommerce::categories.edit', compact('category', 'categories', 'menu_control', 'filters', 'options'));
