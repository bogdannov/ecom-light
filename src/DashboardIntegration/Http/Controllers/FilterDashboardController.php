...
class FilterDashboardController extends Controller
{
    ...
    public function index(Ecommerce $ecommerce)
    {
        ...
        $content = view('ecommerce::filters.filters', compact('filters', 'menu_control'));
    ...
    public function create(Ecommerce $ecommerce)
    {
        ...
        $content = view('ecommerce::filters.create', compact('filter', 'option_groups', 'menu_control'));
    ...
    public function edit($id, Ecommerce $ecommerce)
    {
        ...
        $content = view('ecommerce::filters.edit', compact('filter', 'menu_control', 'option_groups'));
