...
class OptionGroupDashboardController extends Controller
{
    ...
    public function index(Ecommerce $ecommerce)
    {
        ...
        $content = view('ecommerce::option-groups.option-groups', compact('option_groups', 'menu_control'));
    ...
    public function create()
    {
        ...
        $content = view('ecommerce::option-groups.create', compact('option_group', 'menu_control'));
    ...
    public function edit($id, Ecommerce $ecommerce)
    {
        ...
        $content =  view('ecommerce::option-groups.edit', compact('option_group', 'menu_control'));
