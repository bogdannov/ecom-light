...
class OptionDashboardController extends Controller
{
    ...
    public function create($option_group_id, Ecommerce $ecommerce)
    {
        ...
        $content = view('ecommerce::options.create', compact('option', 'option_groups', 'menu_control'));
    ...
    public function edit($id, Ecommerce $ecommerce)
    {
        ...
        $content = view('ecommerce::options.edit', compact('option', 'option_groups', 'menu_control'));
