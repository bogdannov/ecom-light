...
class ProductDashboardController extends Controller
{
    ...
    public function index(Ecommerce $ecommerce, BaseRequest $request)
    {
        ...
        $content = view('ecommerce::products.products', compact('products', 'menu_control', 'categories', 'filter', 'products_data'));
     ...
     *
     */
    public function export(BaseRequest $request, Ecommerce $ecommerce)
    {
        $request_params = $request->all();
        $categories_id = null;
     ...
     *
     */
    public function import(BaseRequest $request, Ecommerce $ecommerce)
    {
        ...
        $ecommerce->productCreateTableCopy();
    ...
    public function create(Ecommerce $ecommerce)
    {
        ...
        $content =  view('ecommerce::products.create', compact('menu_control', 'product', 'categories', 'filter'));
    ...
    public function edit($product_id, Ecommerce $ecommerce)
    {
        ...
        $content =  view('ecommerce::products.edit', compact('menu_control', 'product', 'categories', 'filter'));
