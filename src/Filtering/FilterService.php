...
class FilterService extends ProductRepo
{
     ...
     * @return bool
     */
    public function products($category_id, array $options, $products_per_page = false, $active_only = true)
    {
        ...
        return $this->realGetMany($product_query, $products_per_page, $active_only);
