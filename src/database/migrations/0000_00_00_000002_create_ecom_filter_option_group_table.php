...
class CreateEcomFilterOptionGroupTable extends Migration
{
    ...
    {
        Schema::table('ecom_filter_option_group', function (Blueprint $table) {
            $table->dropForeign('ecom_filter_option_group_filter_id_foreign');
            $table->dropForeign('ecom_filter_option_group_option_group_id_foreign');
